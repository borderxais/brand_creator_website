...
export default function PrivateDomainDataService() {
  ...
  const hashtagOptions = ["facial beauty product", "health product", "sports product"];

  const genderOptions = ["F", "M"];

  const ageRangeOptions = ["18-24", "25-34", "35-44", "45-54", "55-64", "65 and older", "N/A"];
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-lg shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-6">
            Your data request has been processed. You will receive a CSV file with your filtered
            data via email within 24 hours.
          </p>
          <button
            onClick={() => {
              setSubmitted(false);
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-gray-800 mb-4">Private Domain Data Service</h1>
            <p className="text-gray-600">
              Download targeted customer data from our database. Select your filters below and
              we&apos;ll email you a CSV file with the requested information including personal
              address, city, children status, gender, homeowner status, marital status, and more.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setFormData((prev) => ({ ...prev, dataCount: parseInt(e.target.value) }))
                }
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
            ...
            {/* States */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-3">States</label>
          ...
          <div className="mt-8 p-4 bg-gray-50 rounded-lg">
            ...
            <ul className="text-sm text-gray-600 space-y-1">
              ...
              <li>
                • Data includes: personal address, city, children status, gender, homeowner status,
