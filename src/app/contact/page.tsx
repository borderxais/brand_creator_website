                      ...
                      <div className="mt-1">
                        ...
                        <div className="mt-1 flex justify-between">
                          {errors.message ? (
                            ...
                            <p className="text-sm text-gray-500">
                              Provide details about your inquiry (minimum 10 characters)
                            </p>
                          )}
                          <p className="text-xs text-gray-400">
            ...
            <div className="bg-white shadow rounded-lg p-6 mb-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a
                    href="mailto:info@borderxmedia.com"
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">For business and partnership inquiries.</p>
                  <a
                    href="mailto:sam@borderxmedia.com"
                    className="text-sm text-purple-600 hover:text-purple-800"
                  >
