        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 mx-auto">
              Boderx provides you with powerful tools to find the perfect creators for your brand campaigns.
            </p>
          </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Find Creators</h3>
                    <p className="mt-5 text-base text-gray-500">
                      Discover creators across multiple platforms that align with your brand values and target audience.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Connect</h3>
                    <p className="mt-5 text-base text-gray-500">
                      Easily connect with creators and start conversations to build meaningful partnerships.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                  <div className="-mt-6">
                    ...
                    <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Analyze Results</h3>
                    <p className="mt-5 text-base text-gray-500">
                      Track campaign performance with detailed analytics to optimize your creator partnerships.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="bg-purple-800">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            ...
            <span className="block text-purple-300">Start exploring our creator network today.</span>
          </h2>
