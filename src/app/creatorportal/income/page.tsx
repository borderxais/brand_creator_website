...
const dailyIncomeData = Array(30)
  .fill(0)
  .map((_, index) => ({
    day: index + 1,
    income: 0,
    ...
    <div className="space-y-6">
      <div className="bg-white shadow rounded-lg">
        <div className="p-6">
          ...
          <p className="mt-2 text-sm text-gray-600">Manage your earnings and withdrawal options</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white shadow rounded-lg p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link
              href="/creatorportal/income/history"
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900">
                ${incomeData[activeTimeFilter].total.toLocaleString()}
              </p>
            </div>
            <div className="text-gray-500 bg-gray-50 px-3 py-1 rounded-full text-sm">
              {getPercentChange(
                incomeData[activeTimeFilter].total,
                previousData[activeTimeFilter].total
              ) === 0
                ? "No previous data"
          ...
          <div className="mt-4">
            <p className="text-sm text-gray-500">
              Start earning by applying to campaigns and completing collaborations
            </p>
          </div>
        </div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              className="bg-gray-400 text-white px-4 py-2 rounded-md flex items-center cursor-not-allowed"
              disabled
            >
          ...
          <div className="mt-4">
            <p className="text-sm text-gray-500">
              Complete campaigns to start earning and enable withdrawals
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="grid grid-cols-5 gap-4 mb-8">
          {incomeTypes.map((type) => (
            ...
            >
              <h3
                className={`font-medium ${selectedIncomeType === type.id ? `text-${type.color}-700` : "text-gray-700"}`}
              >
                {type.label}
              </h3>
              ...
              <div
                className={`text-xs mt-1 ${
                  getPercentChange(
                    incomeData[activeTimeFilter][type.id],
                    previousData[activeTimeFilter][type.id]
                  ) === 0
                    ? "text-gray-500"
                    : getPercentChange(
                          incomeData[activeTimeFilter][type.id],
        ...
        <div className="space-y-6 mt-8">
          ...
          <div className="space-y-4">
            {timePeriods.map((period) => {
              ...
              const currentValue =
                incomeData[period.id as keyof IncomeDataType][selectedIncomeType];
              const previousValue =
                previousData[period.id as keyof IncomeDataType][selectedIncomeType];
                    ...
                    <div className="flex-1 mx-4">
                      <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                        <div
                          ...
                          style={{
                            width: `${percentChange === 0 ? 0 : Math.min(Math.abs(percentChange), 100)}%`,
                          }}
                        ></div>
                      </div>
                    </div>
      ...
      <div className="bg-white shadow rounded-lg p-6">
          ...
          <div>
            ...
            <IncomePieChart
              ...
              incomeData={Object.fromEntries(
                Object.entries(incomeData[activeTimeFilter]).filter(([key]) => key !== "total")
              )}
        ...
        <div className="mt-8 border-t pt-4">
          <h3 className="text-sm font-medium mb-3">
            Income Summary for {timePeriods.find((p) => p.id === activeTimeFilter)?.label}
          </h3>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <div className="text-xl font-bold">
                ${previousData[activeTimeFilter].total.toLocaleString()}
              </div>
            </div>
          </div>
        </div>
