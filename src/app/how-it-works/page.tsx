  ...
  const creatorSteps = [
    {
      ...
      description:
        "Sign up and build your professional profile showcasing your expertise, audience demographics, and past collaborations.",
      icon: "👤",
    ...
    },
    {
      ...
      description:
        "Explore brand campaigns that match your niche and style. Filter by industry, budget, and content type.",
      icon: "🔍",
    ...
    },
    {
      ...
      description:
        "Apply to campaigns with your creative ideas and pricing. Stand out with your unique value proposition.",
      icon: "✍️",
    ...
    },
    {
      ...
      description:
        "Once approved, create authentic content that resonates with your audience while meeting brand guidelines.",
      icon: "🎨",
    ...
    },
    {
      title: "Get Paid",
      description:
        "Receive secure payments for your work through our platform. Track earnings and manage your income.",
      icon: "💰",
  ...
  const brandSteps = [
    {
      ...
      description:
        "Set up your brand profile with your company details, brand guidelines, and campaign preferences.",
      icon: "🏢",
    ...
    },
    {
      ...
      description:
        "Create detailed campaign briefs specifying your goals, requirements, and budget. Set targeting criteria for creators.",
      icon: "📢",
      gradient: "from-indigo-400 to-purple-600",
    },
    {
      ...
      description:
        "Evaluate creator applications, review their portfolios, and select the best matches for your campaign.",
      icon: "📋",
    ...
    },
    {
      title: "Collaborate",
      description:
        "Work directly with creators, provide feedback, and approve content before publication.",
      icon: "🤝",
    ...
    },
    {
      title: "Track Results",
      description:
        "Monitor campaign performance, engagement metrics, and ROI through our analytics dashboard.",
      icon: "📊",
    ...
    <div className="bg-white overflow-hidden">
      ...
      <div className="relative bg-gradient-to-br from-purple-900 via-indigo-900 to-purple-900 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          ></div>
          <div
            className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-indigo-500/20 rounded-full blur-3xl animate-pulse"
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          ></div>
          <div
            className="absolute top-40 right-20 w-3 h-3 bg-white/30 rounded-full animate-bounce"
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className="absolute bottom-32 left-20 w-5 h-5 bg-white/15 rounded-full animate-bounce"
            style={{ animationDelay: "2s" }}
          ></div>
          <div
            className="absolute bottom-20 right-40 w-2 h-2 bg-white/25 rounded-full animate-bounce"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="text-center">
            ...
            <p
              className="text-xl md:text-2xl text-purple-100 max-w-3xl mx-auto mb-12 leading-relaxed animate-fade-in-up"
              style={{ animationDelay: "0.2s" }}
            >
              A powerful platform connecting brands with creators for authentic collaborations that
              drive real results.
            </p>

            {/* Enhanced Tabs with Glassmorphism */}
            <div
              className="flex justify-center space-x-6 mb-16 animate-fade-in-up"
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div
            className="relative w-full rounded-3xl overflow-hidden shadow-2xl bg-gradient-to-br from-white to-gray-50 p-2 animate-fade-in-up"
            style={{ animationDelay: "0.2s" }}
          >
                ...
                <Image
                  ...
                  onError={(e) => {
                    ...
                    if (e.currentTarget) {
                      ...
                      if (parent) {
                        parent.innerHTML +=
                          '<div class="p-8 text-center"><div class="text-6xl mb-4">🎨</div><h3 class="text-xl font-semibold text-gray-700 mb-2">Visual Guide Coming Soon</h3><p class="text-gray-500">We\'re preparing an amazing visual journey for you!</p></div>';
                      }
                    }
                  }}
                />
      ...
      <div className="bg-gradient-to-br from-purple-900 via-purple-900 to-indigo-900 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="text-center mb-20">
            ...
            <p
              className="text-xl text-purple-100 max-w-3xl mx-auto leading-relaxed animate-fade-in-up"
              style={{ animationDelay: "0.1s" }}
            >
              {activeTab === "creator"
      ...
      <div className="bg-gradient-to-r from-purple-600 via-purple-600 to-indigo-600 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-24">
          <div className="text-center">
            ...
            <p
              className="text-xl text-purple-100 mb-12 max-w-3xl mx-auto leading-relaxed animate-fade-in-up"
              style={{ animationDelay: "0.1s" }}
            >
              {activeTab === "creator"
