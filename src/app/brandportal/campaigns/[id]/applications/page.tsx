                ...
                <span className="ml-2 text-sm">
                  {(() => {
                    try {
                      ...
                      return Array.isArray(ethnicities)
                        ? ethnicities.join(", ")
                        : campaign.creator_profile_preference_ethnicity;
                    } catch (_e) {
                  ...
                  <div className="flex-1">
                      ...
                      <div>
                        <h3 className="font-medium">
                          {application.creator?.username ||
                            "Creator " + application.creator_id.substring(0, 6)}
                        </h3>
                          ...
                          <div className="flex flex-wrap gap-2 mb-2">
                            {application.creator.followerCount !== undefined && (
                              <span>
                                ...
                                {application.creator.followerCount.toLocaleString()}
                              </span>
                            )}
                            {application.creator.engagementRate && (
                              <span>
                                <span className="font-medium ml-2">Engagement:</span>{" "}
                                {application.creator.engagementRate}
                              </span>
                            )}
                          </div>
                    ...
                    {application.sample_video_url && (
                      <div>
                        ...
                        <a
                          href={
                            application.sample_video_url.startsWith("http")
                              ? application.sample_video_url
